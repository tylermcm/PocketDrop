...
set LIBS=ws2_32.lib iphlpapi.lib winhttp.lib wintrust.lib crypt32.lib bcrypt.lib ole32.lib oleaut32.lib shell32.lib windowscodecs.lib gdi32.lib user32.lib advapi32.lib uuid.lib
